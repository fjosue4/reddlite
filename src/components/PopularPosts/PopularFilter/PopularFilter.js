...
const PopularFilter = () => {
    ...
    const [colorNewest, setColorNewest] = useState('#1484D6');

    const [colorMostVoted, setColorMostVoted] = useState('#878A8C');
